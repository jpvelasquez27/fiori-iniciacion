		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#bcsupportinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bcsupportinvoices-display": {
								"semanticObject": "bcsupportinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bcsupport.invoices",
									"url": sap.ui.require.toUrl("bcsupport/invoices")
								}
							}
						}
					}
